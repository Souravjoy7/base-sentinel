...
contract BridgeValidator {
    ...
    uint256 public  LARGE_TRANSFER_THRESHOLD = 1000 * 1e18; // 1000 tokens
    uint256 public  RUSH_THRESHOLD = 10; // 10 transfers in 5 minutes
    uint256 public  TIME_WINDOW = 300; // 5 minutes
